    ...
    <div class="row" v-if="product != null" data-test-product>
      ...
      <div class="col-lg-8">
        <div class="row">
          ...
          <div v-if="userData.admin || userData.id == product.seller.id" class="col-lg-6 text-end">
            <RouterLink
        ...
        <table class="table table-striped" data-test-bids>
          ...
          <tbody>
            <tr v-for="bid in product.bids" :key="bid.id" data-test-bid>
              ...
              <td>
                <button v-if="userData.admin || userData.id == bid.bidder.id" @click="deleteBid(bid.id)" class="btn btn-danger btn-sm" data-test-delete-bid>
                  Supprimer
                </button>
              </td>
            </tr>
